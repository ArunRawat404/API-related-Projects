...
class QuizInterface:
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"You reached the end of the quiz")
            self.true_button.config(state="disabled")  # to deactivate button press
    ...
    def give_feedback(self, is_right):
        ...
        self.window.after(1000, self.get_next_question)  # after 1 sec new question will appear
